...
Decoder and linked-TV commands have no confirmed playback or input feedback.
The configured HDMI input is requested when tuning without reading the TV source.
"""
...
class TotalplayMediaPlayer(MediaPlayerEntity):
    ...
    def __init__(self, hass: HomeAssistant, entry: ConfigEntry) -> None:
        ...
        self._last_tv_input_check = "disabled"
        self._last_tv_input_request = "not_requested"
    ...
    def extra_state_attributes(self) -> dict[str, str | None]:
        ...
        return {
            ...
            "tv_input_request": self._last_tv_input_request,
        }
    ...
    async def _ensure_tv_input(self) -> None:
        """Request the configured input; do not inspect or verify its state."""
        self._last_tv_input_request = await async_ensure_display_source(self._hass, self._entry)
